...
{
    public partial class ucListBillImportCCDC : UserControl
    {
        ...
        public ucListBillImportCCDC(string userid)
        {
            InitializeComponent();
        ...
        void InitializeListBill()
        {
            ...
            _BillImportMaterial = BillImportMaterialControl.LoadListBillImportMaterial();
        ...
        {
            string statusBillID = lbStatusID.Text.Trim();
